...
<section class="hero">
    <div class="hero__content fade-in">
        <span class="hero__eyebrow">🎟️ EventFlow Portugal</span>
        <h1 class="hero__title">Descobre os melhores <span>eventos</span> perto de ti</h1>
        <p class="hero__sub">Música, tecnologia, cultura, desporto — encontra o teu próximo evento e inscreve-te em segundos.</p>
        <div class="hero__actions">
            <a href="/pages/eventos.php" class="btn btn--primary btn--lg">Explorar eventos</a>
            <?php if (!isLoggedIn()): ?>
            <a href="/pages/registo.php" class="btn btn--ghost btn--lg">Criar conta grátis</a>
            <?php endif; ?>
        </div>
...
<div class="container">
    <div class="stats-strip fade-in-2">
        ...
        <div class="stat-item">
            ...
            <div class="stat-item__lbl">Inscrições feitas</div>
        </div>
        <div class="stat-item">
...
<section class="section">
    <div class="container">
        <div class="section-header">
            ...
            <a href="/pages/eventos.php" class="see-all">Ver todos →</a>
        </div>
        ...
        <div class="empty-state">
            ...
            <p>Ainda não há eventos publicados. Volta mais tarde!</p>
...
<section class="section" style="background: linear-gradient(135deg, rgba(255,92,40,.08) 0%, rgba(255,179,71,.05) 100%); border-top: 1px solid var(--clr-border); border-bottom: 1px solid var(--clr-border);">
    <div class="container" style="text-align:center; max-width:600px; margin:0 auto;">
        ...
        <p style="color:var(--clr-muted); margin-bottom:28px;">Cria a tua conta como organizador e começa a gerir eventos com o EventFlow — gratuito, simples e poderoso.</p>
        <a href="/pages/registo.php" class="btn btn--primary btn--lg">Começar agora</a>
    </div>
</section>
<?php endif; ?>
